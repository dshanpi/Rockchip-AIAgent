...
python3 serial_agent_daemon.py --port /dev/ttyUSB0 --baudrate 1500000 --unix-sock /tmp/rk3506-serial.sock --log-file /tmp/rk3506-serial.log
```
...
- daemon 持续写 `/tmp/rk3506-serial.log`。
